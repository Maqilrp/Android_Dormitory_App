...
@Composable
fun Admin_Paket(navController: NavController) {
    val items = listOf(
    ...
    var showPaketContent by rememberSaveable { mutableStateOf(false) }
    ...
    Scaffold(
        ...
        AdminPaketContent(
            ...
            showPaketContent = showPaketContent,
            onPaketClick = { showPaketContent = !showPaketContent }
        )
    }
}

@Composable
fun AdminPaketContent(
    modifier: Modifier = Modifier,
    navController: NavController,
    showPaketContent: Boolean,
    onPaketClick: () -> Unit
) {
    Column(
        modifier = modifier
...
@Composable
fun AdminMenuPaketButton(label: String, icon: ImageVector, onClick: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
