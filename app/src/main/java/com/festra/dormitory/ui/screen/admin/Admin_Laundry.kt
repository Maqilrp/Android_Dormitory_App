...
@Composable
fun Admin_Laundry(navController: NavController) {
    val items = listOf(
    ...
    var showLaundryContent by rememberSaveable { mutableStateOf(false) }
    ...
    Scaffold(
        ...
        AdminLaundryContent(
            ...
            showLaundryContent = showLaundryContent,
            onLaundryClick = { showLaundryContent = !showLaundryContent }
        )
    }
}

@Composable
fun AdminLaundryContent(
    modifier: Modifier = Modifier,
    navController: NavController,
    showLaundryContent: Boolean,
    onLaundryClick: () -> Unit
) {
    Column(
        modifier = modifier
...
@Composable
fun AdminMenuLaundryButton(label: String, icon: ImageVector, onClick: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
