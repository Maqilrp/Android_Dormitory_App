...
@Composable
fun Admin_Listrik(navController: NavController) {
    val items = listOf(
    ...
    var showListrikContent by rememberSaveable { mutableStateOf(false) }
    ...
    Scaffold(
        ...
        AdminListrikContent(
            ...
            showListrikContent = showListrikContent,
            onListrikClick = { showListrikContent = !showListrikContent }
        )
    }
}

@Composable
fun AdminListrikContent(
    modifier: Modifier = Modifier,
    navController: NavController,
    showListrikContent: Boolean,
    onListrikClick: () -> Unit
) {
    Column(
        modifier = modifier
        ...
        AdminMenuButton(
            ...
            onClick = onListrikClick

        )

        if (showListrikContent) {
            Spacer(modifier = Modifier.height(16.dp))
            ListrikContent()
        }
    }
...
@Composable
fun AdminMenuListrikButton(label: String, icon: ImageVector, onClick: () -> Unit) {
    Row(
        modifier = Modifier
            .fillMaxWidth()
